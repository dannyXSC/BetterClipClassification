...
# 根目录
root = "../datas/absolute_size_10000-19999"
# 每个文件夹里要显示图片的名字
img_name_list = [f"{i}.jpg" for i in range(3)] + ['init_img.jpg', 'init_mask.jpg']
# 每行显示多少个图片
img_col_num = 3
img_row_num = (len(img_name_list) - 1) // img_col_num + 1
# 要的数据（文件夹的 id）保存的位置
reserve_path = "../absolute_size/reserve.txt"
# 不要的数据保存的位置
discard_path = "../absolute_size/discard.txt"
# 要显示的metadata里的内容
